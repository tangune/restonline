...
<div class="header">
    <div class="container">
        ...
        <div class="top_right">
            {{--<ul><li><a href="{{url('registar')}}">Registe seu restaurante</a></li>|--}}
                <ul><li><a href="{{url('/usuarios/create')}}">Regista-se</a></li>|
                <li class="login" >
...
<div class="grid_3">
    <div class="container">
       <!-- <ul id="footer-links">
        ...
        <p>Copyright © 2017 Swakuda Software Development. Todos direitos reservados.</p>
    </div>
</div>
</body>
</html>